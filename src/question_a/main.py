from question_a import get_stock_list, get_stock_purchases, stock_purchase_history, company_purchase_history
...
def main():
    ...
    while run_again.lower() == "y":
        ...
        decision = input("1-Display stock purchase history\n2-Display stock purchase history by company\n3-Exit")
        ...
        if decision == "1":
            ...
            print(company_purchase_history(stock_dictionary, stock_purchases_list))
            run_again = input("Do you have another report to pull? Y or N")
            if run_again.lower() == "n":
                print("Thanks for running my Stocks Program")
                quit()
